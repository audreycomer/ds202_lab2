...
```{r}
dark80<-choco[choco$Cocoa.Pct>80,]
names(dark80) <- dark80$Company.Location #this is wrong, I also tried choco$Company.Location, that didn't work either
sort(dark80$Cocoa.Pct, decreasing=T) 
